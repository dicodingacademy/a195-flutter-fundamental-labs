// todo-03-provider-01: create a new provider to handle a read-write file
import 'package:file_app/service/file_service.dart';
import 'package:flutter/widgets.dart';

class FileProvider extends ChangeNotifier {
  // todo-03-provider-02: inject a file service to this provider
  final FileService _service;

  FileProvider(this._service);

  // todo-03-provider-03: add a state and get method to handle a contents
  String? _contents;
  ...
  // todo-03-provider-04: add a function to save a file
  ...
  // todo-03-provider-05: add a function to read a file
  ...
  // todo-03-provider-06: add a function to read a file
